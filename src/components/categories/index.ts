...
export default class Showcase extends LitElement {
  ...
  goPrev() {
    this.leftIndex = (this.leftIndex - 1 + this.slides.length) % this.slides.length;
    this.rightIndex = (this.rightIndex - 1 + this.slides.length) % this.slides.length;
  }
  ...
  renderSide(side: string) {
    ...
    return html`
      <div class="ds-inner overflow-hidden" 
        ...
        <div class="swiper ds-bg" id="ds-bg-${side}-${this.position}">
          <div class="swiper-wrapper">
            ${this.slides.map((i, idx) => {
              ...
              if (!bg) return html``;
              return html`
                <div class="swiper-slide slide-item ${idx === activeIndex ? 'active' : ''}">
                  <div class="ds-ratio">
        ...
        <!-- Thumbnails Slides -->
        <div class="swiper ds-thumbs" id="ds-thumbs-${side}-${this.position}" 
             data-sal="zoom-in"
